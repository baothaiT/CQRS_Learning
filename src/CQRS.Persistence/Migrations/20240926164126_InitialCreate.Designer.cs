...
namespace CQRS.Persistence.Migrations
{
    ...
    [Migration("20240926164126_InitialCreate")]
            ...
            modelBuilder.Entity("CQRS.Domain.Entities.AccountEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f1fad7d7-7aa8-44ca-87d6-3aa27db11414"),
                            CreateDate = new DateTime(2024, 9, 26, 23, 41, 25, 736, DateTimeKind.Local).AddTicks(6654),
                            Email = "User@example.com",
                            IsDelete = false,
                            IsStatus = true,
                            Password = "UserPass",
                            Proxy = new Guid("fff4e167-5595-41ed-825e-d1f59c640089"),
                            UserName = "User1",
                            UserType = new Guid("32b6df0d-da33-48af-8616-062c748af79e")
                        },
                        new
                        {
                            Id = new Guid("d50c7da5-947a-4324-8f93-887c23ef204e"),
                            CreateDate = new DateTime(2024, 9, 26, 23, 41, 25, 736, DateTimeKind.Local).AddTicks(6665),
                            Email = "User@example.com",
                            IsDelete = false,
                            IsStatus = true,
                            Password = "UserPass",
                            Proxy = new Guid("fff4e167-5595-41ed-825e-d1f59c640089"),
                            UserName = "User2",
                            UserType = new Guid("35154da0-0fb2-40d2-b6ec-19ff0d50085b")
                        },
                        new
                        {
                            Id = new Guid("d6d5636f-7ca4-4ba2-a625-803988257fe5"),
                            CreateDate = new DateTime(2024, 9, 26, 23, 41, 25, 736, DateTimeKind.Local).AddTicks(6667),
                            Email = "User@example.com",
                            IsDelete = false,
                            IsStatus = true,
                            Password = "UserPass",
            ...
            modelBuilder.Entity("CQRS.Domain.Entities.AccountTypeEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("32b6df0d-da33-48af-8616-062c748af79e"),
                            IsDelete = false,
                            TypeName = 0
                        },
                        new
                        {
                            Id = new Guid("35154da0-0fb2-40d2-b6ec-19ff0d50085b"),
                            IsDelete = false,
                            TypeName = 1
                        });
                });
            ...
            modelBuilder.Entity("CQRS.Domain.Entities.ProxyEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fff4e167-5595-41ed-825e-d1f59c640089"),
                            Ip = "192.168.1.1",
                            IsDelete = false,
                            Password = "proxyPass1",
                            Port = 8080,
